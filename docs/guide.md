...
The current stable release is [2023.10.21].
...
Use the `--checkout` option with the [current stable release][2023.10.21]:
...
[2023.10.21]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2023.10.21
