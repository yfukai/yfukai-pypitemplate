...
The current stable release is [2024.3.26].
...
Use the `--checkout` option with the [current stable release][2024.3.26]:

```console
cruft create https://github.com/statisticsnorway/ssb-pypitemplate.git --checkout=2024.3.26
```
...
[2024.3.26]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2024.3.26
