...
The current stable release is [2024.9.10].
...
Use the `--checkout` option with the [current stable release][2024.9.10]:
...
[2024.9.10]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2024.9.10
