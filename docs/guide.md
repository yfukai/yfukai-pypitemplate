...
The current stable release is [2025.1.13].
...
Use the `--checkout` option with the [current stable release][2025.1.13]:
...
[2025.1.13]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2025.1.13
