...
The current stable release is [2023.11.15].
...
Use the `--checkout` option with the [current stable release][2023.11.15]:
...
[2023.11.15]: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2023.11.15
